...
A function that allows you to modify the entity just before it is spawned.  
   This is useful if you want to customize the entity, such as setting its name or other properties, right after creation.
    ...
    <Tabs syncKey="lang">
        <TabItem label="Kotlin">
            ...
            { capybara ->
                ...
                bukkitCapybara.isCustomNameVisible = true // Make the name always visible
            }
            ```
        </TabItem>
        <TabItem label="Java">
            ...
            capybara -> {
                ...
                bukkitCapybara.customName(Component.text("Ben the capybara"));
                bukkitCapybara.setCustomNameVisible(true); // Make the name always visible
            }
            ```
        </TabItem>
    </Tabs>