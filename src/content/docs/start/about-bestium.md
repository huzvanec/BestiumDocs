...
Bestium is a powerful plugin library for [PaperMC](https://papermc.io/) that lets you create custom entities with unique behavior without extending concrete Minecraft classes.
...
☝️ A Capybara in vanilla Minecraft
