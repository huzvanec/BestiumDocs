...
<Tabs syncKey="lang">
  <TabItem label="Kotlin">
    ```kotlin Bestium.getEntityManager().isInjected(entity) ```
  </TabItem>
  <TabItem label="Java">
    ```java Bestium.getEntityManager().isInjected(entity); ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="lang">
  <TabItem label="Kotlin">
    ```kotlin val injection = Bestium.getEntityManager().getInjection(entity)
    ```
  </TabItem>
  <TabItem label="Java">
    ```java EntityInjection injection =
    Bestium.getEntityManager().getInjection(entity); ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="lang">
  <TabItem label="Kotlin">
    ```kotlin val injection =
    Bestium.getEntityManager().requireInjection(entity) ```
  </TabItem>
  <TabItem label="Java">
    ```java EntityInjection injection =
    Bestium.getEntityManager().requireInjection(entity); ```
