...
<Tabs syncKey="lang">
  <TabItem label="Kotlin">
    ```kotlin EntityInjection.builder(...).build() ```
  </TabItem>
  <TabItem label="Java">
    ```java EntityInjection.builder(...).build(); ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="lang">
  <TabItem label="Kotlin">
    ```kotlin .setDisplayName(Locale.US, Component.text("Capybara"))
  ...
  <TabItem label="Java">
    ```java .setDisplayName(Locale.US, Component.text("Capybara"))
    .setDisplayName(Locale.FRANCE, Component.text("Capybara"))
    .setDisplayName(Locale.GERMANY, Component.text("Wasserschwein"))
    .setDisplayName(Locale.ITALY, Component.text("Capibara"))
    .setDisplayName(Locale.JAPAN, Component.text("カピバラ"))
