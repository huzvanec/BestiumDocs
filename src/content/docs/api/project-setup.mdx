...
- [paperweight-userdev](https://docs.papermc.io/paper/dev/userdev/) for access to Minecraft internals (also known as NMS).
...
<Tabs syncKey="lang">
  <TabItem label="Kotlin">
    ```kotlin import cz.jeme.bestium.api.Bestium ```
  </TabItem>
  <TabItem label="Java">
    ```java import cz.jeme.bestium.api.Bestium; ```
  </TabItem>
</Tabs>
...
This is essential for registering custom entities with Bestium.
...
To access Bestium's API during runtime, you need to add it as a plugin dependency.
